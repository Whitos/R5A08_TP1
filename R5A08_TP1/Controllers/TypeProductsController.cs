...
namespace R5A08_TP1.Controllers
{
    ...
    public class TypeProductsController : ControllerBase
    {
        ...
        public TypeProductsController(IDataRepository<TypeProduct> dataRepository, IMapper mapper)
        {
        ...
        public async Task<ActionResult<TypeProductDto>> Get(int id)
        {
            ...
            var dto = _mapper.Map<TypeProductDto>(typeproduct.Value);
            return Ok(dto);
        }
        ...
        public async Task<IActionResult> Update(int id, TypeProductDto dto)
        {
            ...
            existingTypeProduct.Value.NameTypeProduct = dto.NameTypeProduct;

            await dataRepository.UpdateAsync(existingTypeProduct.Value, existingTypeProduct.Value);

            var updatedDto = _mapper.Map<TypeProductDto>(existingTypeProduct.Value);
